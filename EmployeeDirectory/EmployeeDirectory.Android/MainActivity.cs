	...
	public class MainActivity : FormsAppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            CopyInfoIntoWorkingFolder("XamarinFavorites.xml",
                EmployeeDirectory.Android.Resource.Raw.XamarinFavorites, false);
            CopyInfoIntoWorkingFolder("Directory.xlsx",
                EmployeeDirectory.Android.Resource.Raw.Directory, true);
            CopyInfoIntoWorkingFolder("Telefonbuchexport.xlsx",
                EmployeeDirectory.Android.Resource.Raw.Directory, true);
        ...
        private void CopyInfoIntoWorkingFolder(string fileName, int resourceId, bool overwrite)
        {
            ...
            if (!File.Exists(destination))
            {
                ...
                var writeStream = new FileStream(destination, FileMode.OpenOrCreate, FileAccess.Write);
