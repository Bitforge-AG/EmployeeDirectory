    ...
    public class Search
    {
        ...
        public Filter Filter
        {
            get
            {
                ...
                if (Property == SearchProperty.Alle)
                {
                    return new OrFilter(
                        new ContainsFilter("Personen", trimmed),
                        new ContainsFilter("Dienstnummer", trimmed),
                        new ContainsFilter("Stationszimmer", trimmed),
                        new ContainsFilter("Diposition", trimmed),
                        new ContainsFilter("Wichtig", trimmed));
                }
                else
                {
